...
int main ()
{
    ...
    *pPointer = 10; // assign a value to the first element
    ...
    /*increment the pointer using pointer arithmetic to assign the adress of the second element to the pointer*/
    pPointer++;
    *pPointer = 20; // assign a value to the second element

    // assign the address of the third element to third element to the pointer
    ...
    *pPointer = 40; // assign avalue to the fourth element
